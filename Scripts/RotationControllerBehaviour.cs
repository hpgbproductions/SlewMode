...
public class RotationControllerBehaviour : Jundroo.SimplePlanes.ModTools.Parts.PartModifierBehaviour
{
    private RotationController modifier;
    ...
    private void Start()
    {
        modifier = (RotationController)PartModifier;
    ...
    private void FixedUpdate()
    {
        ...
        {
            aircraftInfo.SetGlobalRotation(InputVector);
        }
        else if (ControlMode == SlewModeCommon.ControlModes.Velocity)
        {
            aircraftInfo.SetAngularVelocity(InputVector, ControlSpace);
        }
        else    // Acceleration
        {
            aircraftInfo.AngularAccelerate(InputVector, ControlSpace);
        }
    }
}