...
/// </summary>
[Serializable]
public class InputChannel : Jundroo.SimplePlanes.ModTools.Parts.PartModifier
{
    [SerializeField]
    ...
    [SerializeField]
    [DesignerPropertyToggleButton(Label = "Component", Order = 10)]
    private SlewModeCommon.VectorComponents _component = SlewModeCommon.VectorComponents.X;
    ...
    public override Jundroo.SimplePlanes.ModTools.Parts.PartModifierBehaviour Initialize(UnityEngine.GameObject partRootObject)
    {
        ...
        var behaviour = partRootObject.AddComponent<InputChannelBehaviour>();
        return behaviour;
    }
}